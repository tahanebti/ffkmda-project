...
export class ExtranetService {
  ...
  searchByCommune(query?: any, page?: PageableSearch): Observable<Page<any>> {
    ...
    return this._http.get<Page<any>>(`http://localhost:8080/api/v1/clubs/address?commune=${query}`, { params: params })
  }
  ...
  searchByCodePostal(query?: any, page?: PageableSearch): Observable<Page<any>> {
    ...
    return this._http.get<Page<any>>(`http://localhost:8080/api/v1/clubs/address?code_postal_fr=${query}`, { params: params })
  }
  ...
  searchByDep(query: any, page?: PageableSearch): Observable<any> {
    ...
    return this._http.get<Page<any>>(`http://localhost:8080/api/v1/clubs/address?code_insee_departement=${query}`, { params: params })
  }
  ...
  //http://localhost:8080/api/v1/clubs/address?code_insee_departement
